  ...
  <div class="mainwrapperinner">
    <div class="mainleft">
      <div class="mainleftinner">
        <div class="leftmenu">
          <ul>
            <li class="current"><a href="dashboard.jsp" class="dashboard"><span>Dashboard</span></a></li>
    ...
    <div class="maincontent">
      <div class="maincontentinner">
        <ul class="maintabmenu">
          <li class="current"><a href="javascript:;">Dashboard</a></li>
        </ul>
        <!--maintabmenu-->
        
        <div class="content">
          <div class="contenttitle">
            <h2 class="table"><span class="dashboard">Process to file</span></h2>
          </div>
           <!--contenttitle-->
			...
			%>
              <tr class="gradeA">
                ...
                <td><% if(d == 1){out.println("<span style='color:green'>Approved</span>");} else { out.println("");} %></td>
	             ...
	             <td>
	           			<button type="button" class="btn" onclick="btnClicked2(<%= id %>)">Process</button>
	           </td> 
              </tr>
              <% 
...
<% }/*
		 ...
		 out.println("<h1>Invalid Access</h1><br>Go back and enter correct password<a href='adminlogin.jsp'>Admin Login</a>");
	 }*/%>